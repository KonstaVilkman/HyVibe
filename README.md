...
| Metric | Value | Date |
|--------|-------|------|
| **Current Phase** | Phase 0A - Minimal Lobby | Jan 21, 2025 |
...
| Task | Status |
|------|--------|
| Lobby build (Penthouse Bar) | `SKETCHING` |
| Server setup | `NOT STARTED` |
| Basic plugins (LuckPerms etc) | `NOT STARTED` |
| Spawn system working | `NOT STARTED` |
| First playtesters | `NOT STARTED` |
| Barebone, XP / Leveling | `DESIGNED` |
| Minigames | `PLANNED` |
...
| System | Status |
|--------|--------|
| Economy (Cash/Gems/Crystals) | `DESIGNED` |
| Housing (5 tiers) | `DESIGNED` |
| Lootboxes | `DESIGNED` |
