...
**Fantasy:** You move packages around the city.
...
4. Navigate to destination (marker on map)
5. Arrive within time limit
6. Receive payment

**Skill Expression:** Route knowledge, speed, managing multiple deliveries
...
2. Start shift
3. NPCs approach with orders (speech bubbles)
4. Click correct items / navigate menu
5. Speed and accuracy = bonus pay
6. End shift when done

**Skill Expression:** Speed, accuracy, multitasking

---

### Retail

**Fantasy:** You work at a shop keeping it running.
...
1. Go to shop
2. Check what needs restocking (visual indicators)
3. Grab items from back room
4. Place on correct shelves
5. Clean spills/messes
6. Assist NPC customers between tasks

**Skill Expression:** Efficiency, prioritization, store knowledge

---

### Fishing

**Fantasy:** Relaxing fishing with collectible catches.
...
2. Cast line (click)
3. Wait for bite (visual/audio cue)
4. Reel in (timing minigame?)
5. Receive fish (rarity based on spot + RNG)
6. Sell fish or keep for collection
...
**Fantasy:** You perform or DJ for other players.
...
2. Access booth (requires Skilled unlock)
3. Select music/tracks from playlist
4. Crowd size grows based on song choices
5. Earn based on crowd engagement
6. Longer sets = more rewards
...
## Job Progression Incentives

### Why Level Up Jobs?

| Milestone | Reward | Incentive |
|-----------|--------|-----------|
...
| Benefit | Details |
|---------|---------|
| Higher pay | 2-3x Entry pay |
| More Fame | +1-2 Fame per task |
| Exclusive content | Access areas only Skilled can enter |
| Cosmetics | Skilled-tier outfits |
| Prestige | Visible skill commitment |
...
**Players can do any job at any time.** No commitment required.

| Rule | Reasoning |
|------|-----------|
| Switch freely | Variety keeps gameplay fresh |
| All progress saved | Never lose job levels |
...
**First job task each day = 2x rewards**

Encourages daily engagement without forcing grind.
...
Jobs provide:
- Active earning alternative to minigames
